...
public class TestHomeDeliverySignup {
	...
	public RemoteWebDriver createDriver(String targetEnvironment) throws MalformedURLException {
		...
		capabilities.setCapability("securityToken", "eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICJzbFV4OFFBdjdVellIajd4YWstR0tTbE43UjFNSllDbC1TRVJiTlU1RFlFIn0..sWscPrVxozQdHvM82T3dq8s61JWK0Ngm-SSN6vSwE55w5ZQWC7zY1AsWA9oSBKN_rFXoknFnJ_WySdS7oCjbPSRwTkzfFcrTMnQhTZjdUxt6lm5RpkCBrtZVNR96oiGXU1tm6hi6V6EPF4BAW8dHGksD9DUd-4KVku6Q88gT2Yck0M3xM-096X7L7Y0VldUAozjwSSY-Yx3c70ZC3W6sYcIEbqJicQbhbvzetNdkfxt5YVNSYQvXCyw4sZ4TkgHJNzNzmMECapvWBLCwUulIAe4Qb5W6_b4SZxK8ZBS9z5qvdCqqFphpBwJhwCvzkQga6TjhSqUwMjp_h6vSDLRkIw");
	...
	public void enterDetails() {
		...
		driver.findElement(By.xpath("//input[@id='txtDeliveryFirstName']")).sendKeys("Tzvika");
		driver.findElement(By.xpath("//input[@id='txtDeliveryLastName']")).sendKeys("Shahaf");
		driver.findElement(By.xpath("//input[@id='txtDeliveryAddress1']")).sendKeys("25 corporate Dr.");
		driver.findElement(By.xpath("//input[@id='txtDeliveryAddress2']")).sendKeys("suite 2");
		...
		driver.findElement(By.xpath("//input[@id='txtDeliveryEMail']")).sendKeys("tzvikas@perfectomobile.com");
		takeScreenshot();
